...
describe('Freestyle project - Rename project', () => {
    ...
    it.only('AT_12.03.003| <Freestyle project> Verify renamed project from Freestyle project page is accessible and visible on the Jenkins dashboard under the new name.', function () {
