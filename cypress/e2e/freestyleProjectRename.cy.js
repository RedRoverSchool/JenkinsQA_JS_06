...
describe('Freestyle project - Rename project', () => {
    ...
    it.only('AT_12.03.003| <Freestyle project> Verify that the existing project was renamed from Freestyle project page, and now is accessible and visible on the Jenkins dashboard under the new name.', function () {
